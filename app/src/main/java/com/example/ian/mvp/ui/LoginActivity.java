                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        BmobUser.resetPasswordByEmail(codeInfo, new UpdateListener() {
                            ...
                            public void done(BmobException e) {
                                if(e==null){
                                    Toast.makeText(LoginActivity.this,"重置密码请求成功，请到" + codeInfo + "邮箱进行密码重置操作",Toast.LENGTH_SHORT).show();
                                }else{
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode){
            case TAKE_PICTURE:
                ...
                Glide.with(LoginActivity.this).load(img_url1).asBitmap().into(mImageView);
                Glide.with(LoginActivity.this).load(img_url1).asBitmap().into(img);
                //将图片URI转换成存储路径
